...
func (a *app) readiness(ctx context.Context, w http.ResponseWriter, r *http.Request) web.MockEncoder {
...
func (a *app) liveness(ctx context.Context, w http.ResponseWriter, r *http.Request) web.MockEncoder {
